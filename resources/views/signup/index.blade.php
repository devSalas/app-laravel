        ...
        <div class="md:w-1/2 max-w-lg mx-auto my-24 px-4 py-5 shadow-none">
            ...
            <form  action="" method="post" class="p-0" >
                ...
                <div class="mt-5">
                    ...
                    <input type="email" class="block w-full p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent " placeholder="Email" name="email">
                </div>
                <div class="mt-5">
                    <input type="user" class="block w-full p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent " placeholder="User-name" name="user">
                </div>
                <div class="mt-5">
                    <input type="password" class="block w-full p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent  " placeholder="Password" name="password">
                </div>
